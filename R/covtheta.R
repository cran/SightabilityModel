...
function(total, srates, stratum, subunit, covars,betas, varbetas, nboots){
 ...
 #  3. Subunit = subunit identifier 
 #  4. covars = matrix of covariates used in the sightability model
 #  5. beta = vector of parameter estimates from logistic model
 #  6. varbeta = var/cov matrix for above parameter estimates
