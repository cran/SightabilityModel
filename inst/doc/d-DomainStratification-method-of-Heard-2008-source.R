...
#' dealt with when using *MoosePopR_DomeStrat()* and *SightabilityPopR()*.
#' 
...
#' #### Abundance
#' 
#' The estimates of density computed using the *SightabilityPopR()* family of funtions
...
#' which create "stata" based on a combination of stratum and domain values.
...
#' different from the two functions when adjusting for sightability because the *MoosePopR()* famly has no mechanism
