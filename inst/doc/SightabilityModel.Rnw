...
known:
\begin{eqnarray}
v_{1} & = &  \sum_{i=1}^{n}\frac{1-\pi_{i}}{\pi_{i}}\hat{\tau}_{i}^{2}+\sum_{i \neq i'}^{n}\frac{\pi_{i,i'}-\pi_{i}\pi_{i'}}{\pi_{i}\pi_{i'}}\hat{\tau}_{i}\hat{\tau}_{i'}\\
...
\begin{eqnarray}
v_{s}'& = &   v_{1}+v_{2}-v_{d} \nonumber \\
&= & \sum_{i=1}^{n}\frac{1-\pi_{i}}{\pi_{i}^{2}}\hat{\tau}_{i}^{2}+\sum_{i \neq i'}^{n}\frac{\pi_{i,i'}-\pi_{i}\pi_{i'}}{\pi_{i}\pi_{i'}}\hat{\tau}_{i}\hat{\tau}_{i'} -  \sum_{i=1}^{n}\frac{
...
& & \mbox{} - \sum_{i \neq i'}^{n}\frac{\pi_{i,i'}-\pi_{i}\pi_{i'}}{\pi_{i}\pi_{i'}}\sum_{j=1}^{m_{i}}\sum_{j'=1}^{m_{i'}}y_{i,j}y_{i',j'}\widehat{\COV}(\hat{\theta}_{i,j},\hat{\theta}_{i',j'})\\
v_{d}^{*} & = &
...
For a more concise summary, on can use the \code{summary} function,
